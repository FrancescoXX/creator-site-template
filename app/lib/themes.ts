...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    colors: {
      background:
        "linear-gradient(135deg, #d45959 0%, #c94d62 25%, #3a9b94 75%, #4a5fc8 100%)",
      primary: "#ffffff",
      secondary: "#d45959",
      accent: "#3a9b94",
      border: "#c94d62",
  ...
  },
  {
    ...
    colors: {
      background:
        "linear-gradient(135deg, #4a3f2a 0%, #6b5d42 50%, #8b7a5a 100%)",
      primary: "#ffffff",
      secondary: "#4a3f2a",
      accent: "#d4c4a0",
      border: "#6b5d42",
